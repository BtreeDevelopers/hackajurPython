...
def return_garantia_real(documento, dadosPagamento, pessoa, is_pf):
    ...
    <b>CLÁUSULA TERCEIRA</b> – DA GARANTIA REAL
    
    O DEVEDOR em ato de boa-fé, indica como garantia real do presente termo de confissão de dívida, o seguinte bem;
    
    · Tipo de Bem: Carro, Moto ou Casa
    ...
    (ESPECIFICAR IMÓVEL), devidamente registrado em nome dos devedores junto ao Cartório de Registro de Imóveis desta Comarca de CIDADE-UF, sob o nº TAL.
