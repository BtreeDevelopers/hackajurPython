...
def return_proposta_fiador_template(documento, dadosPagamento, pessoa, fiador, is_pf):
    ...
    <b>FIADOR</b>: {fiador.nome}, {fiador.nacionalidade}, {fiador.estado_civil}, portador do CPF nº {fiador.cpf}, residente e domiciliado no endereço {fiador.endereco}. 
    ...
    2.1 Reconhecendo como boa a origem da dívida, o DEVEDOR e o FIADOR, comprometem-se a pagar na seguinte conformidade:
    ...
    Parágrafo Primeiro: O não pagamento de qualquer parcela na data aprazada, importará no vencimento integral e antecipado do débito, sujeitando o DEVEDOR e o FIADOR, além da execução do presente instrumento, ao pagamento do valor integral do débito, sobre o qual incidirá a aplicação de multa de 10%, juros de mora de 1% ao mês e correção monetária e mais custas processuais e honorários advocatícios na base de 20% sobre o valor total do débito. Os valores monetários serão corrigidos de acordo com a tabela da Corregedoria do Egrégio Tribunal de Justiça de Minas Gerais.
    
    Parágrafo Segundo: Fica autorizado desde já, em caso de inadimplência, o desconto dos valores devidos diretamente no salário da DEVEDORA e/ou FIADOR, até o importe de 30%, bem como penhora de suas contas poupanças, até o limite do débito, ficando estabelecido para tanto negócio jurídico processual, nos termos do art. 190 do Código de Processo Civil (CPC/2015).
    
    <b>CLÁUSULA TERCEIRA</b> – FIADOR
    
    Como garantidor solidário do pagamento da quantia mencionada na Cláusula Segunda. Resta qualificado o fiador acima, sendo que o mesmo está ciente da quantia e das condições descrito neste instrumento
    
    <b>CLÁUSULA QUARTA</b>  – DA EXIGIBILIDADE DA DÍVIDA
    
    3.1 - A DÍVIDA ora reconhecida e assumida pelo DEVEDOR e FIADOR como líquida, certa e exigível, no valor acima mencionado, aplica-se o disposto no artigo 784, III, do Código de Processo Civil Brasileiro, haja vista o caráter de título executivo extrajudicial do presente instrumento de confissão de dívida.
    ...
    As partes declaram, para os devidos fins, que nos termos da Resolução TRE/PA nº 5.689/2021 c/c Resolução CNJ nº 345, de 9/10/2020, Lei nº 13.105 ( CPC) e Lei nº 11.419 de 19/12/2006, optam pelo JUÍZO 100% DIGITAL, autorizando citação e comunicação dos atos processuais pelo WhatsApp,  nos termos do art. 190 do Código de Processo Civil (CPC/2015).
