...
def return_propsta_debito(documento, dadosPagamento, pessoa, numero_cartao_debito, is_pf):
    ...
    2.1.1 – no valor de {dadosPagamento.valor_formatado_descontado} ({dadosPagamento.valor_descontado_por_extenso}) a serem pagos pelo DEVEDOR, através do cartão de débito {numero_cartao_debito}.
    ...
    Para dirimir qualquer dúvida oriunda deste instrumento fica eleito o Foro da Comarca de ______________, com exclusão de qualquer outro por mais privilegiado que seja.
