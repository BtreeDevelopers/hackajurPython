...
def return_boleto_template(documento, dadosPagamento, pessoa, numero_boleto, is_pf):
    ...
    return f"""
        ...
        2.1.1 – no valor de {dadosPagamento.valor_formatado_descontado} ({dadosPagamento.valor_descontado_por_extenso}) a serem pagos pelo DEVEDOR, através de boleto nº {numero_boleto} emitido com vencimento de 05 dias a contar do primeiro dia útil após a assinatura do presente instrumento.
        ...
        Para dirimir qualquer dúvida oriunda deste instrumento fica eleito o Foro da Comarca de {numero_boleto}, com exclusão de qualquer outro por mais privilegiado que seja.
