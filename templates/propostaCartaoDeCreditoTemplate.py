...
def return_propsta_cartao_credito_template(documento, dadosPagamento, pessoa, numero_cartao_credito, is_pf):
    ...
    Para dirimir qualquer dúvida oriunda deste instrumento fica eleito o Foro da Comarca de {numero_cartao_credito}, com exclusão de qualquer outro por mais privilegiado que seja.
